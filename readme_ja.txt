...
=1.8.3=
Sep 15, 2026: WordPress7.1の仕様変更に伴い、PHP fatal errorのバグが発生しました。このバグには、2026年9月14日まで気づきませんでしたが、ChatGPT-5.6 Solの支援を得てfixいたしました。その他、クッキー部分の表示の乱れのバグ、assetsファイルのテンプレートサンプルが消失していたバグなどを修正しました。
